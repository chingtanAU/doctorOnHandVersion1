...
class ClinicDetailsContoller extends GetxController {
  ...
  late Rx<DoctorProfile> doctorData = Rx<DoctorProfile>(DoctorProfile.empty());
  late RxString doctorId= "".obs;


  Future<DoctorProfile?> setDoctordata(String? clinicId) async {

    await userCrud.getDoctorByClinicId(clinicId).then((value) => doctorData.value=value!);
